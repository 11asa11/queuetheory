...
class Lab():
    def __init__(self):
        self.generator = self.Generation()

    class Generation():
        def __init(self, exponential = True, lambda_var = None, a = None, b = None, n = None, y = None):
            self.array_of_y = []
            self.array_of_tau = []
    ...
    def Analytics(self, y, n, tau = None, lambda_var = None, a = None, b = None):
        ...
        analyzer = self.Analyzer(y, n, tau = tau, param_lambda = lambda_var, a = a, b = b)
        exit_flag = True
    ...
    def part1(self, array_of_y, array_of_tau, ostream_serviced_reqs, ostream_lost_reqs):
